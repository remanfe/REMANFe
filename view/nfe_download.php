            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    if ($_SESSION['tipo_usuario'] == 1) {
                        ...
                        ?>
                        <form action="nfe_download.php" method="POST" autocomplete="off">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 button-listar">
                                        <input type="submit" value="Download" name="download" class="btn btn-success form-control" />
                                    </div>
                                    <?php
                    ...
                    <table class="table table-hover table-striped">
                        <tr class="row">
                            ...
                            <th class="col-md-1">
                                <span><b>Data/Hora emissão</b></span>			
                            </th>
                            <th class="col-md-3">
