                    ...
                    <table class="table table-hover table-striped">
                        ...
                        if (isset($_POST['codigoNFe'])) {
                            ...
                            for ($i = 0; $i < count($retorno); $i++) {
                                ...
                                echo "</td>";
                                echo "<td class='col-md-3'>";
                                echo "	<a href='?acao=excluir&codigoNFe=" . $retorno[$i]['cNF_nfe'] . "'><img src='../components/images/icons/delete16.png' alt='Excluir' title='Excluir' class='img-espaco'></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        }
...
if (isset($_REQUEST['acao'])) {
    if ($_REQUEST['acao'] == "excluir") {
        ...
        echo "<script language='javascript'> alert('NFe excluída com sucesso!')</script>";
    }
}
?>